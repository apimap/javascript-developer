      ...
      <HorizontalLargeSmallStackLayout>
        <HorizontalStackLayout>
          <TableOfContents>
            ...
            <TableOfContentsItem :scroll="taxonomydocument" section="III." title="Taxonomy Document">
            ...
            <TableOfContentsItem :scroll="structure" section="IV." title="Taxonomy Document Structure">
          ...
          <ContentSection ref="taxonomydocument" title="III. Taxonomy Document">
            ...
            <p>
              It is recommended to name your taxonomy file taxonomy.apimap . This will ensure automatic recognition from
            ...
            <p>Gives little value to the consumer, and SHALL be seen as guidance to the governance team when seeking
              help.</p>
            <h5>Level 2 (Required)</h5>
            <p>Gives value to the consumer and used to categorize the API when the producer is unable to find an
              appropriate level 3 category.</p>
            <h5>Level 3 (Optional)</h5>
            <p>This level gives real value when restricting searches and separating functionality. Producers MUST use
              multiple level 3 categorizations instead of level 2 to span a wide range of possibilities.</p>
            <h4 ref="roles">Roles</h4>
            <h5>Producer</h5>
            <p>A producer MUST select the appropriate options from the taxonomy collection by using the URN associated
              with the entity. An updated taxonomy collection is availed from the Apimap Portal.</p>
            <h5>Consumer</h5>
            ...
            <p>
              ...
              creates a dynamic taxonomy definition. The following schema is used: urn:&lt;taxonomy name&gt;:&lt;random
              number&gt;
            </p>
            ...
            <p>
              Keeping your metadata and taxonomy files in the same folder will enable the build system to automatically
              detect and
            ...
            <Recommendation
                recommendation="Although not a requirement it is recommended to create individual folders for each API and keep the metadata and taxonomy files together."/>
          </ContentSection>
          <ContentSection ref="structure" title="IV. Taxonomy Document Structure">
            <Recommendation
                recommendation="A key concept of the taxonomy.apimap file is that there will never be a requirement to update the content unless your API changes."/>
          ...
          <ContentSection ref="changemanagement" title="V. Change Management">
            <p>
              The Apimap.io project governs the content of this document and the Taxonomy Specification herein. Any
              organization that
